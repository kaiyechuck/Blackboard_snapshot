...
while n:
    ...
    if ts == 2:
        ...
        if if_new_rst == 1:
            ...
            upload.upload_file(path_dictionary['before_erasing'], "boardsnapshot",object_name=path_dictionary['new'])
            upload.upload_file(path_dictionary['old'], "boardsnapshot",object_name=path_dictionary['old']) # this is uploaded only for testing
